    ...
    return (
        <div className='flex flex-col m-8 gap-6'>
            <div className='flex gap-3'>
                <div className='flex gap-5 h-fit items-center justify-between bg-primary rounded-md p-2 px-3 text-white'>
                ...
                <div className='flex h-fit items-center gap-3 justify-between border-2 border-primary h-[100] rounded-md p-2 pr-3 text-3xl font-bold'>
                    <span>😃</span>
                    <span>60%</span>
                </div>
                <div className='flex h-fit items-center gap-3 justify-between border-2 border-primary h-[100] rounded-md p-2 pr-3 text-3xl font-bold'>
