      ...
      <Select>
        ...
        <SelectContent className='text-md'>
          <SelectGroup>
            ...
            <SelectItem key="0" value="Name">Name</SelectItem>
            <SelectItem key="1" value="PRN">PRN</SelectItem>
            <SelectItem key="2" value="question_1">Rate the technical skills of the teacher</SelectItem>
            <SelectItem key="3" value="question_2">How efficiently were the topics covered?</SelectItem>
            <SelectItem key="4" value="question_3">Were the contents apart from syllabus covered?</SelectItem>
            <SelectItem key="5" value="question_4">Any more suggestions</SelectItem>
          </SelectGroup>
        </SelectContent>
      </Select>
